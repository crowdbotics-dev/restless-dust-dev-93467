"""
Django settings for restless_dust_dev_93467 project.
...
ROOT_URLCONF = 'restless_dust_dev_93467.urls'
...
WSGI_APPLICATION = 'restless_dust_dev_93467.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_dust_dev_93467 API",
    "DESCRIPTION": "API documentation for restless_dust_dev_93467 App",
    "VERSION": "v1",
}
